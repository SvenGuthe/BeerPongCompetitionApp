...
import { homeHierarchy, teamCompositionStatusHierarchy } from "../../utility/hierarchy";
...
const TeamCompositionStatus = () => {
    ...
    return <>
        <Hierarchy hierarchyItems={[homeHierarchy, teamCompositionStatusHierarchy]} />
        <h2>Team Status</h2>
        <EnumOverview url={teamCompositionStatusRoute} storeFunction={storeTeamCompositionStatus} paginationData={teamCompositionStatus} />
    </>
