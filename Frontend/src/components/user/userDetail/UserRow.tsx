...
import useUserRoleCheckboxes from "../../../hooks/use-userRoleCheckboxes";
...
const UserRow: React.FC<{ user: tUserDetail }> = (props) => {
    ...
    const checkboxAdmin = useUserRoleCheckboxes(user, Role.ROLE_ADMINISTRATOR);
    const checkboxMod = useUserRoleCheckboxes(user, Role.ROLE_MODERATOR);
    const checkboxPlayer = useUserRoleCheckboxes(user, Role.ROLE_PLAYER);
