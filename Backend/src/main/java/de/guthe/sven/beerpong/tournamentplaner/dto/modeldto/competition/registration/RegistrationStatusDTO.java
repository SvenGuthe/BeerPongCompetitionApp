package de.guthe.sven.beerpong.tournamentplaner.dto.modeldto.competition.registration;
...
public class RegistrationStatusDTO extends EnumDTO {
	...
	public RegistrationStatusDTO(Long id, RegistrationStatusType registrationStatusDescription, Timestamp creationTime,
	...
	public RegistrationStatusDTO(RegistrationStatusHistory registrationStatusHistory) {
		super(registrationStatusHistory.getId(),
				registrationStatusHistory.getRegistrationStatus().getRegistrationStatusDescription().name());
		this.registrationStatusDescription = registrationStatusHistory.getRegistrationStatus()
