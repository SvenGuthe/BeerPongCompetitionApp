...
public class TeamCompositionStatusDTO extends EnumDTO {
	...
	public TeamCompositionStatusDTO(Long id, TeamCompositionStatusType teamCompositionStatusType, Timestamp validFrom,
			Timestamp validTo) {
	...
	public TeamCompositionStatusDTO(TeamCompositionStatusHistory teamCompositionStatusHistory) {
		super(teamCompositionStatusHistory.getId(),
				teamCompositionStatusHistory.getTeamCompositionStatus().getTeamCompositionStatusType().name());
		this.teamCompositionStatusType = teamCompositionStatusHistory.getTeamCompositionStatus()
				.getTeamCompositionStatusType();
