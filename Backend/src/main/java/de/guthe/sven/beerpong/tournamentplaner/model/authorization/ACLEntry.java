...
@NamedQuery(name = "ACLEntry.findACLEntriesByACLObjectIdentityACLSid", query = "SELECT a FROM ACLEntry a WHERE LOWER(a.objectIdentity.id) = LOWER(?1) AND LOWER(a.aclSid.id) = LOWER(?2)")
